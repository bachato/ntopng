...
async function update_exporter_interfaces() {
    ...
    const url_device_exporter_details =
        NtopUtils.buildURL(`${http_prefix}/lua/pro/rest/v2/exporters/exporters_interfaces.lua?exporter_uuid=${selected_exporter_device.value.id}&ifid=${selected_exporter_device.value.ifid}&ip=${selected_exporter_device.value.ip}`);
