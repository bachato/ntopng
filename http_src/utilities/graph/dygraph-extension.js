...
Dygraph.Plugins.Legend.prototype.select = function(e) {
  ...
  if (legendMode === 'follow') {
    ...
    const yAxisLabelWidth = e.dygraph.getOptionForAxis('axisLabelWidth', 'y');
    ...
    const highlightSeries = e.dygraph.getHighlightSeries();
    let point;
    if (highlightSeries) {
    ...
    let leftLegend = x * area.w + followOffsetX;
