...
export function aysHandleForm(form_selector, options) {
  ...
  const o = $.extend(true, {}, default_options, options);
 ...
 */
export function aysResetForm(form_selector) {
 ...
 */
export function aysUpdateForm(form_selector) {
 ...
 */
export function aysRecheckForm(form_selector) {
 ...
 */
export function aysGetDirty(form_selector, fields_selector) {
  ...
  const isFieldDirty = function($field) {
    ...
    const curValue = getValue($field);
    const dirty = (undefined !== origValue) && (origValue != curValue);
  ...
  $(form_selector).find(fields_selector).each(function() {
    const dirty_status = isFieldDirty($(this));
