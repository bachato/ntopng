...
local host_alert_port_scan = classes.class(alert)

-- ##############################################

host_alert_port_scan.meta = {
  alert_key = host_alert_keys.host_alert_port_scan,
  i18n_title = "alerts_dashboard.port_scan_title",
...
function host_alert_port_scan.format(ifid, alert, alert_type_params)
