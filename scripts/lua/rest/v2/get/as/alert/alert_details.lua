...
--
-- Read alerts data
-- Example: curl -u admin:admin -H "Content-Type: application/json" -d '{"ifid": "1"}' http://localhost:3000/lua/rest/v2/get/as/alert/alert_details.lua
--
...
if row_id and tstamp and alert_entities["as"] then
    local alert_store_instance = alert_store_instances[alert_entities["as"].alert_store_name]
