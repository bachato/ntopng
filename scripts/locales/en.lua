local lang = {
  ...
  ["flow_alerts_explorer"] = {
    ...
    ["alert_ndpi_unresolved_hostname_title"] = "Unresolved Hostname using DNS",
    ["status_ndpi_unresolved_hostname_description"] = "The contacted symbolic hostname was not observed on a previously issued DNS query",
