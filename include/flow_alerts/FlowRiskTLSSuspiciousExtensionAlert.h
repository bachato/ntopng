...
#ifndef _FR_TLS_SUSPICIOUS_EXTENSION_ALERT_H_
#define _FR_TLS_SUSPICIOUS_EXTENSION_ALERT_H_

#include "ntop_includes.h"

class FlowRiskTLSSuspiciousExtensionAlert : public FlowRiskAlert {
 private:
  ndpi_serializer* getAlertJSON(ndpi_serializer* serializer);

 public:
  static ndpi_risk_enum getClassRisk() { return NDPI_TLS_SUSPICIOUS_EXTENSION; }
