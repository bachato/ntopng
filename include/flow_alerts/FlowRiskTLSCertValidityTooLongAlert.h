...
#ifndef _FR_TLS_CERT_VALIDITY_TOO_LONG_ALERT_H_
#define _FR_TLS_CERT_VALIDITY_TOO_LONG_ALERT_H_

#include "ntop_includes.h"

class FlowRiskTLSCertValidityTooLongAlert : public FlowRiskAlert {
 public:
