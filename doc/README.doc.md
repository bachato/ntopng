...
## Enviroment issues with Python

In case of env issue with pip install, create a temporary enviroment by using the following command and install/make the documentation from there:
...
pip install breathe sphinx sphinx-rtd-theme mock rst2pdf sphinxcontrib.swaggerdoc sphinxcontrib.jquery six
```
